function[vars, hiddenvarnum, coeffconsts, sizeofcombs, polycomb, infinitePrec, eqs, actualsolno, noofrowstoreduce, heurisitictemplatesize ] = problem_relpose_7p_fr_1s(data)
tic;
...
if nargout >=7
    eqs = Eqs_problem_relpose_7p_fr_1s(p{:});
else
    eqs = [];
end
vars = transpose(xx);
