function[vars, hiddenvarnum, coeffconsts, sizeofcombs, polycomb, infinitePrec, eqs, actualsolno, noofrowstoreduce, degstotest] = problem_satellite_triang(data)
tic;
...
if nargout >= 7
    eqs = Eqs_problem_satellite_triang(p{:});
else
    eqs = [];
end
