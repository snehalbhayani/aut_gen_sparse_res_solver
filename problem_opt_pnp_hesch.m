function[vars, hiddenvarnum, coeffconsts, sizeofcombs, polycomb, infinitePrec, eqs, theoreticalsolncnt, noofrowstoreduce,heuristictemplatesize] = problem_opt_pnp_hesch(data)
tic;
...
if nargout >=7
    eqs = Eqs_problem_opt_pnp_hesch(p{:});
else
    eqs = [];
end
vars = transpose(xx);
